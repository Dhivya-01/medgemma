...
import { Shield, Wifi, WifiOff, Lock, Server, Eye } from "lucide-react";
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="space-y-4">
            {[
              { icon: WifiOff, title: "Offline Mode", desc: "Full AI capabilities without internet connection" },
              { icon: Lock, title: "End-to-End Encryption", desc: "AES-256 encryption for all data at rest and in transit" },
              { icon: Server, title: "On-Premise Deploy", desc: "Run entirely on your own infrastructure" },
              { icon: Eye, title: "Zero-Knowledge", desc: "We can't see your data, even if we wanted to" },
            ].map((item, i) => (
              <motion.div
                key={item.title}
