...
const sampleMessages = [
  { role: "user", text: "What are the potential drug interactions for my current prescriptions?" },
  { role: "bot", text: "Based on your medication list, I've identified one moderate interaction between Lisinopril and Potassium supplements. I recommend discussing dosage adjustments with your physician. Here's a detailed breakdown..." },
